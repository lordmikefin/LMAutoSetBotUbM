...
"""
    ...
    Latest version of this script file:
      https://github.com/lordmikefin/LMAutoSetBotUbM/blob/master/python/setup_apps.py
...
def activate_virtual_environment():
    ...
    py_home = user_home + '/Envs/venv-LMAutoSetBotUbM'
...
NOTE: this python script was copied from LMAutoSetBotWin project
